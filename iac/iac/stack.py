...
from aws_cdk import RemovalPolicy, Stack, Duration, Size, CfnOutput
...
class LambdaConfig:
    ...
    handler: str = "handler"
    environment: BaseSettings | None = None
...
class RAGStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        lambda_config = LambdaConfig(
            ...
            memory_size_mb=512,
            environment=IndexerSettings(s3_bucket_name=bucket.bucket_name),
        )
